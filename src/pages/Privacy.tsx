  ...
  <AppShell>
    <div className="max-w-3xl bg-card border border-border rounded-lg p-8 space-y-4">
      ...
      <p className="text-sm text-muted-foreground leading-relaxed">
        NATIONAL SKILL REGISTRY collects only the minimum personal information required to issue and verify skill credentials: name, trade, institution and the issued credentials themselves. We do not sell or share personal data with third parties.
      </p>
      <p className="text-sm text-muted-foreground leading-relaxed">
