  ...
  <AppShell>
    <div className="max-w-3xl bg-card border border-border rounded-lg p-8 space-y-4">
      ...
      <p className="text-sm text-muted-foreground leading-relaxed">
        By accessing Credify you agree to use the platform solely for lawful credential issuance and verification. Credentials are issued only by authorised ITI and Polytechnic institutions whitelisted by the system administrator.
      </p>
      <p className="text-sm text-muted-foreground leading-relaxed">
